...
async function classifyQuoteItems(pdfText, categories, instructions = DEFAULT_CLASSIFICATION_INSTRUCTIONS, products = []) {
  ...
  return applyRegisteredProductOverrides(parseClassificationResponse(content, categoryValues), products);
}
