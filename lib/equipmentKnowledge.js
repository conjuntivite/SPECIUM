...
// Uma linha = um card, mesmo com categoria repetida: o catálogo é genérico (Endpoint 4 Portas e
// Endpoint FULL caem ambos em "Controladora de Acesso") e somar esconderia o que cada card é —
...
function buildBudgetFromClassified(classified, categories) {
  ...
  return { items, positions, connections, unclassified, skipped };
}
