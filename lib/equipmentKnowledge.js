...
// Assistente de conversa (aba "Assistente ONE/SIAM"): aqui vão TODAS as fichas de uma vez (~3k tokens),
...
function buildAssistantSystemPrompt() {
  return [
    'Você é o assistente técnico do SPECIUM para projetos de controle de acesso e portaria remota com equipamentos ONE PORTARIA e SIAM.',
    'Responda em português do Brasil, direto e prático (listas curtas quando ajudar): o que é preciso, quantidades, ligações, limites e cuidados de instalação.',
    'Use SOMENTE as fichas abaixo como fonte sobre ONE e SIAM. Se a resposta não estiver nelas, diga claramente que as fichas não cobrem isso, em vez de inventar número, modelo ou limite.',
    'Cada ficha vale só para o modelo que ela nomeia: não aplique o limite de um modelo a outro (ex.: os 30 endpoints são do Córtex AG, não do V5/V6).',
    'Conhecimento geral de segurança eletrônica (cabeamento, fontes, rede) pode complementar, mas deixe claro quando não vem das fichas.',
    '',
    'Fichas técnicas:',
...
module.exports = { EQUIPMENT_KNOWLEDGE, relevantKnowledge, validateAssistantMessages, buildAssistantSystemPrompt, askEquipmentAssistant };
