...
// é — separado, o comercial escolhe o produto certo em cada um. Posições em fileiras por função e
// ligações típicas entre elas: lib/budgetLinks.js.
function buildBudgetFromClassified(classified, categories) {
  ...
  const { positions, connections } = layoutAndLinkItems(items);
  return { items, positions, connections, skipped };
}
