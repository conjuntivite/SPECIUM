...
// Base do link enviado no e-mail de redefinição de senha; trocar no .env ao hospedar.
...
module.exports = { loadLocalEnvironment, PORT, HOST, APP_URL, STATIC_DIRECTORY, UPLOADS_DIRECTORY, MIME_TYPES };
